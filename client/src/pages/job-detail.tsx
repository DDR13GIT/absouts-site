...
export default function JobDetail() {
  ...
  return (
    <div className="pt-16" data-testid="job-detail-page">
      <section className="py-8 bg-gradient-to-br from-slate-50 via-white to-blue-50">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg p-8 border-0">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                  <div className="flex items-center">
                    ...
                    <span className="text-green-800 font-medium">This position is currently open for applications</span>
                  </div>
                </div>
              </div>
